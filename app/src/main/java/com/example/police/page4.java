    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        selectedTime.setOnClickListener(new View.OnClickListener() {
            ...
            private void showTimePickerDialog() {
                ...
                TimePickerDialog timePickerDialog = new TimePickerDialog(page4.this,
        ...
        date.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(page4.this,
        ...
        String[] district = new String[]{"ariyalur", "chengalpattu", "chennai", "coimbatore",
                ...
                "tirunelveli", "tirupathur", "tiruppur", "tiruvkallakurichiallur", "tiruvannamalai", "tiruvarur",
